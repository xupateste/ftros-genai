...
AUDIT_KNOWLEDGE_BASE = {
    "oportunidad_clase_b": {
        ...
        "how": [
            "Ejecuta el 'Análisis Estratégico de Rotación' para monitorear su 'Índice de Importancia'.",
    ...
    "inconsistencias_datos_criticos": {
        "why": "'Basura entra, basura sale'. Si los datos de tus productos más importantes son incorrectos (ej. precio de compra en cero), todos los análisis de rentabilidad y estrategia en esta plataforma serán imprecisos. Corregir esto es fundamental.",
        "how": [
