...
AUDIT_KNOWLEDGE_BASE = {
    ...
    "quiebre_stock_clase_a": {
        "why": "Un producto '🌟 Estrella' es uno de tus items más importantes y rentables. Un quiebre de stock significa que estás perdiendo ventas directas en tus productos más valiosos y, peor aún, arriesgando que un cliente fiel se vaya a la competencia.",
        "how": [
    ...
    "stock_muerto_alto_valor": {
        ...
        "how": [
            ...
            "Crea una oferta 'combo', empaquetando este producto con un '🌟 Estrella' de alta venta.",
    ...
    "inversion_ineficiente_clase_c": {
        "why": "Los productos 'Clase C' son la 'larga cola' de tu inventario. Son necesarios, pero invertir demasiado capital en reponerlos puede desviar recursos de tus verdaderos motores de venta ('🌟 Estrella'). Se trata de optimizar cada sol gastado.",
        "how": [
