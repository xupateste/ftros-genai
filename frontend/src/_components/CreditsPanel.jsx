...
export function CreditsPanel({ used, remaining, onHistoryClick }) {
  return (
    ...
    <div className="flex mx-auto w-full max-w-md hover:bg-gray-800 hover:ring-1 hover:ring-purple-700 cursor-pointer bg-gray-800 border border-gray-700 rounded-lg shadow-lg overflow-hidden">
      
      {/* 2. Sección de Créditos Usados (Clickeable) */}
      <div onClick={onHistoryClick} className="flex-1 p-3 md:p-4 text-center transition-colors duration-200">
      ...
      <div onClick={onHistoryClick} className="flex-1 p-3 md:p-4 text-center bg-purple-900 bg-opacity-30">
