...
const reportData = {
  "🧠 Diagnósticos útiles": [
    ...
    { label: 'Diagnóstico de productos sin rotación (stock muerto) ✓', endpoint: '/diagnostico-stock-muerto', insights: [],
      parameters: [
    ...
    {
      label: 'Diagnóstico de rotación de productos (avanzado) ✓',
  ...
  "📦 Reposición Inteligente y Sugerencias de Pedido": [
    ...
    { label: 'Lista básica de reposición según histórico', endpoint: '/sobrestock', insights: [], parameters: [] },
